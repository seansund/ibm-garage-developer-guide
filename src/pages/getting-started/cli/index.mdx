...
#### Note: If your environment is restricted, Please consider installing Cloud Shell Commands options.
...
<InlineNotification kind="warning">
**warning:** Specify toolkit if you want to install specific version
'npm i -g @ibmgaragecloud/cloud-native-toolkit-cli@0.40'
</InlineNotification>
...
```
#### Note: Jenkins is the default if no value is provided.
...
```bash
igc pipeline -n dev-team-a --jenkins
```
